...
public class ZoneManager : MonoBehaviour
{
    ...
    public void OnTrashCleaned(ZoneArea.ZoneType zoneType, string trashName, Color textColor)
    {
        if (_zoneDict.TryGetValue(zoneType, out ZoneArea targetZone))
        {
            ...
            if (FloatingTextManager.Instance != null)
            {
                ...
                FloatingTextManager.Instance.ShowText(message, textColor);
            }
        }
    }
    ...
    private string GetKoreanZoneName(ZoneArea.ZoneType zoneType)
    {
        switch (zoneType)
        {
            case ZoneArea.ZoneType.LivingRoom: return "거실";
            case ZoneArea.ZoneType.Kitchen: return "주방";
            case ZoneArea.ZoneType.MasterRoom: return "안방";
            case ZoneArea.ZoneType.DrawingRoom: return "응접실";
            case ZoneArea.ZoneType.Hallway1: return "복도1";
            case ZoneArea.ZoneType.Hallway2: return "복도2";
            case ZoneArea.ZoneType.SpareRoom: return "작은방";
            default: return "구역";
        }
    }
